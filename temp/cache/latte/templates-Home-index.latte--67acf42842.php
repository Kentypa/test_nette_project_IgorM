...
/** source: C:\Users\12ora\Downloads\test_nette_project_IgorM\App\Presenters/templates/Home/index.latte */
final class Template67acf42842 extends Latte\Runtime\Template
{
	public const Blocks = [
...
';
	...
	public function prepare(): array
	{
		...
		if (!$this->getReferringTemplate() || $this->getReferenceType() === 'extends') {
			foreach (array_intersect_key(['person' => '13'], $this->params) as $ʟ_v => $ʟ_l) {
